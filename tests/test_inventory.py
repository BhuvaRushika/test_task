import pytest
from testdemo.src.models.inventory import Category, Product, ProductFactory, Inventory
...
test_product_invalid_input()
test_inventory_add_product()
test_inventory_duplicate_product()
test_inventory_remove_product()
test_inventory_get_products_by_category()